...
def _save_word_to_db(user_message, bot, base_language_word, base_language_code):
    ...
    try:
        save_word(user, base_language_word, learning_language_word)
        ...
        print(f"The word {base_language_word} = {learning_language_word} has been added to the dictionary for user {user.id}")
