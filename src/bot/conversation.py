...
def _manageConversation(message, bot, newConversation, userConversation):
    """
    ...
    try:
        if newConversation:
            ...
            # print(f"system message: {userConversation}")
            ...
            bot.register_next_step_handler(
                message, lambda msg: _get_llm_response(msg, userConversation, client, bot)
            )
        else:
            bot.register_next_step_handler(
                message, lambda msg: _get_llm_response(msg, userConversation, client, bot)
...
def _get_llm_response(userMessage, userConversation, client, bot):
    """
    ...
    if userMessage.text == "end":
        ...
        _manageConversation(userMessage, bot, False, userConversation)
